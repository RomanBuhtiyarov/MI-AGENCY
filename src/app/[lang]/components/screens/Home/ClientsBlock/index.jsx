  ...
  return (
    <section className='mt-[21px]'>
      ...
      <div className='grid grid-cols-2 gap-4 mt-[30px] md:flex md:flex-nowrap md:justify-evenly mobile:justify-normal'>
        <div className='flex flex-col min-w-[200px] mobile:min-w-[185px] w-min items-center text-center'>
          ...
          <p className='text-[15px] mobile:text-[14px] uppercase mt-[14px] font-unbounded leading-[20.8px] text-transparent bg-gradient-to-r from-[#347AEC] to-[#6764E7] bg-clip-text'>
        ...
        <div className='flex flex-col min-w-[200px] mobile:min-w-[185px] w-min items-center text-center mobile:mt-[30px]'>
          <div className='w-[117px] h-[117px] bg-white rounded-full flex items-center justify-center drop-shadow-drop'>
