        ...
        description: (
          <p className="text-[#262626] font-[400] leading-5 tracking-wide">
            ...
            <span className="font-semibold">
              {lang.paei_page.description_2}
            </span>{" "}
            {lang.paei_page.description_3}{" "}
            <span className="font-semibold">
              {lang.paei_page.description_4}
            </span>
            {lang.paei_page.description_5}{" "}
            <span className="font-semibold">
              {lang.paei_page.description_6}
            </span>
          </p>
        ),
        children: (
      ...
      page: {
        ...
        description: (
          <p className="font-[500] leading-[130%]">
            <span className="text-[#262626] font-[700]">
              {lang.enneagram_page.title}
            </span>{" "}
            {lang.enneagram_page.description_1} <br />{" "}
            {lang.enneagram_page.description_2} <br />{" "}
            {lang.enneagram_page.description_3}
          </p>
        ),
        children: (
          <section>
              ...
              <div className="w-full md:w-[400px] relative md:border md:border-solid md:border-2 md:border-[#347AEC] py-[15px] md:px-[24px] w-[369px] rounded-[15px]">
                <div className="text-[#262626] leading-[130%]">
                  ...
                  <h3 className="font-[700]">
                    {lang.enneagram_page.robot_hint_h3}
                  </h3>
                </div>
              </div>
              <Image
