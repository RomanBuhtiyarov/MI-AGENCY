...
const NextPrevButton = ({
  ...
  return (
    <button
      className={` ${className} py-[3px] px-[6px] rounded-[8px] text-[12px] text-[#262626] font-[500] w-[110px] h-[20px] duration-500 flex items-center justify-between bg-[#347AEC] hover:bg-[#6764E7]  ${
